t1 <- read.table("results/gridResults1439Daisy_poa_4_10p5-pearsonSmallerParams.csv")
t2 <- read.table("results/gridResults1439Daisy_poa_4_10p5_no_iqr_pearson.csv")
t3 <-read.table("results//gridResults1439Daisy_poa_8_p6_iqr_75_pearson.csv")
...
t4 <-read.table("results/gridResults1439Daisy_poa_45_9p5-spearman.csv", sep=",")
t5 <- read.table("results/gridResults1439Daisy_poa_4_10p5_noiqr_spearman.csv")
...
spearmanTable5437 <- read.table("results/5437_small_params_spearman_poa_8_p25_daisy.csv")
