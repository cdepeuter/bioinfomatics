...
uniprottogene = function(gene){return (u133a$U133A_ID[which(u133a$Uniprot_ID %in% gene)])}
...
diffgenesinpathway = function(pathwaygenes){return(unlist(pathwaygenes[which(pathwaygenes %in% diff_genes_uniprot)]))}
